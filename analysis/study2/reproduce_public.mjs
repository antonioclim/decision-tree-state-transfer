/** Publication-safe independent numerical reproduction; does not authorise or generate EXT data.
...
function main(){
  ...
  const protocol=read(path.join(HERE,'../../protocols/study2/I05_STUDY2_PROTOCOL_LOCK.json'));
  assert.equal(protocol.publication_derivative?.derived_from_sha256,'d8eaac46d96f0ffc986e3ac5937112910cb28010e6d2cdc42ab08255aa17a622');
  assert.equal(protocol.publication_derivative?.scientific_content_changed,false);
